...
const MENU_ITEMS: MenuItemTypes[] = [
  ...
  // tasks code here
  { key: "jobtask", label: "Task", isTitle: true },
  {
    key: "task profile",
    label: "Profile",
    isTitle: false,
  ...
  },
  {
    ...
    isTitle: false,
    icon: "filter",
    url: "/jobtask/cultures",
  },
  {
    key: "cultures-options",
    label: "Cultures Option",
    isTitle: false,
    icon: "filter",
    url: "/jobtask/cultures-options",
  },
  {
    key: "antibiotics",
    label: "Antibiotics",
    ...
    children: [
      {
        key: "test",
        label: "Test",
        url: "/jobtask/pricelist/test",
        parentKey: "pricelist-test",
      },
      {
        key: "culture",
        label: "Culture",
        url: "/jobtask/pricelist/culture",
        parentKey: "pricelist-culture",
      },
    ],
  },
// task end
