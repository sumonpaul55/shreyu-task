...
// task
const TaskProfile = React.lazy(() => import("../pages/task/profile/Profile"))
const Invoices = React.lazy(() => import("../pages/task/invoices/Invoices"))
const Reports = React.lazy(() => import("../pages/task/reports/Reports"))
const Branches = React.lazy(() => import("../pages/task/branches/Branches"))
const Tests = React.lazy(() => import("../pages/task/tests/Tests"))
const Cultures = React.lazy(() => import("../pages/task/cultures/Cultures"))
const CulturesOption = React.lazy(() => import("../pages/task/cultureOption/CulturesOption"))
const Antibiotics = React.lazy(() => import("../pages/task/antibiotics/Antibiotics"))
const Doctors = React.lazy(() => import("../pages/task/doctors/Doctors"))
const PriceTest = React.lazy(() => import("../pages/task/priceList/Test"))
const PriceCulture = React.lazy(() => import("../pages/task/priceList/Culture"))
// apps
...
// task
const taskProfileRoutes: RoutesProps = {
  path: "/jobtask/profile",
  name: "TaskProfile",
  route: PrivateRoute,
  roles: ["admin"],
  icon: "user",
...
const invoices: RoutesProps = {
  path: "/jobtask/invoices",
  name: "invoices",
  route: PrivateRoute,
  roles: ["admin"],
  icon: "file",
